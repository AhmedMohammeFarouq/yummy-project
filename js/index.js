    ...
    cartoona += `
        <div class="col-md-3 position-relative ">
                <div onclick="getMealDetails('${arr[i].idMeal}')" class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
                    ...
                    <div class="meal-layer fw-bold position-absolute d-flex flex-column justify-content-center align-items-start text-black ">        
                        <div id="view_details">${arr[i].strMeal}</div>  
                    </div>
    ...
    cartoona += `
        <div class="col-md-3">
                <div onclick="getIngredientsMeals('${
                  arr[i].strIngredient
                }')" class="ingre rounded-2 text-center text-white">
  ...
  let cartoona = `
    <div class="col-md-4 position-relative">
            ...
            <div class="col-md-8">
                ...
                <h3 class="fw-bolder">Area :<span class="m-2 p-1 h4">${meal.strArea}</span> </h3>
                <h3 class="fw-bolder ">Category :<span class="m-2 p-1 h4">${meal.strCategory}</span> </h3>
                <h3>Recipes :</h3>
...
function inputsValidation() {
  // 3aml de 3shan lma kolhm return true a5ly el button enable
...
function passwordValidation() {
  return /[0-9a-zA-Z]{8,}$/.test(document.getElementById("password").value);
}
